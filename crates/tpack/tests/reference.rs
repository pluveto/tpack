...
fn draft_flat_full_schema_hex() -> Vec<u8> {
    vec![
        0x54, 0x50, 0x41, 0x4B, 0x01, 0x00, 0x28, 0x20, 0x05, 0x01, 0x02, 0x69, 0x64, 0x00, 0x0E,
        0x40, 0x02, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x00, 0x0D, 0x12, 0x04, 0x03, 0x03, 0x74,
        0x61, 0x78, 0x00, 0x0C, 0x04, 0x03, 0x71, 0x74, 0x79, 0x00, 0x04, 0x05, 0x02, 0x74, 0x73,
        0x00, 0x05, 0x08, 0x70, 0x72, 0x6F, 0x64, 0x5F, 0x30, 0x30, 0x31, 0xB8, 0x99, 0xEE, 0x02,
        0x06, 0xBA, 0xD6, 0x01, 0x00, 0x00, 0x00, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x66, 0x38, 0xD2,
        0xC0,
    ]
}
...
fn draft_flat_with_id_hex() -> Vec<u8> {
    let mut bytes = vec![
        0x54, 0x50, 0x41, 0x4B, 0x01, 0x01, 0x11, 0x65, 0x78, 0x61, 0x6D, 0x70, 0x6C, 0x65, 0x2E,
        0x72, 0x65, 0x63, 0x6F, 0x72, 0x64, 0x2E, 0x76, 0x31, 0x28,
    ];
...
fn draft_flat_schema_ref_hex() -> Vec<u8> {
    let mut bytes = vec![
        0x54, 0x50, 0x41, 0x4B, 0x01, 0x02, 0x11, 0x65, 0x78, 0x61, 0x6D, 0x70, 0x6C, 0x65, 0x2E,
        0x72, 0x65, 0x63, 0x6F, 0x72, 0x64, 0x2E, 0x76, 0x31,
    ];
...
fn map_duplicate_keys_use_canonical_key_bytes_even_outside_strict_mode() {
    let bytes = vec![
        0x54, 0x50, 0x41, 0x4B, 0x01, 0x00, 0x0B, 0x22, 0x00, 0x24, 0x01, 0x01, b'a', 0x04, 0x02,
        0x00, 0x00, 0x00, 0x01, 0x80, 0x00, 0x00, 0x00, 0x02,
    ];
...
fn decoder_rejects_flags_trailing_bytes_noncanonical_nan_and_varint_overflow() {
    let mut nonzero_flags = vec![
        0x54, 0x50, 0x41, 0x4B, 0x01, 0x00, 0x07, 0x20, 0x01, 0x01, 0x01, b'a', 0x01, 0x04, 0x00,
        0x00, 0x00, 0x01,
    ];
    ...
    let overlong_field_id = vec![
        0x54, 0x50, 0x41, 0x4B, 0x01, 0x00, 0x08, 0x20, 0x01, 0x81, 0x00, 0x01, b'a', 0x00, 0x04,
        0x00, 0x00, 0x00, 0x01,
    ];
    let mut decoder = Decoder::with_options(
        &overlong_field_id,
